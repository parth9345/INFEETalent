...
export function CareerForm({ careerId, careerTitle = 'Selected Position', heading = 'Apply Now', className }: CareerFormProps) {
  return (
    ...
    >
      ...
      <div className="career-form-grid grid gap-[24px]">
        <Field required name="fullName" label="Full name" placeholder="Full Name*" />
        <div className="career-form-row grid gap-[24px] sm:grid-cols-2">
        ...
        <label className="career-file-field flex h-[60px] cursor-pointer items-center justify-between bg-[#FFFFFF]/[0.08] pl-[24px] text-[16px] font-[400] leading-[28px] text-[#FFFFFF] transition hover:bg-[#FFFFFF]/[0.12]">
          <span>Upload CV*</span>
        ...
        <Button type="submit" className="primary-cst-btn career-form-submit h-[50px] w-full border-[0px] bg-[#FCA62B] px-[0px] text-[12px] font-[800] leading-[16px] tracking-[0.48px] text-[#262164] hover:bg-[#FCA62B]/88">
          Submit
        </Button>
      </div>
    </form>
...
function Field({
  ...
  return (
    <input
      ...
      className="career-form-field h-[60px] bg-[#FFFFFF]/[0.08] px-[24px] text-[16px] font-[400] leading-[28px] text-[#FFFFFF] outline-none transition placeholder:text-[#FFFFFF] focus:bg-[#FFFFFF]/[0.12]"
    />
  )
}
...
function SelectField({
  ...
  return (
    <select
      ...
      className="career-form-field h-[60px] bg-[#FFFFFF]/[0.08] px-[24px] text-[16px] font-[400] leading-[28px] text-[#FFFFFF] outline-none transition focus:bg-[#FFFFFF]/[0.12]"
    >
      {placeholder ? (
