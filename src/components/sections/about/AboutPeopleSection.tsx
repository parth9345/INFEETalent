  ...
  return (
    ...
    >
      <Container className="grid max-w-[1500px] gap-[48px] px-[24px] xl:grid-cols-[minmax(0,700px)_minmax(0,740px)] xl:justify-between xl:gap-[48px] xl:px-[24px] xl:pt-[137px] 2xl:gap-[60px] 2xl:px-[0px]">
        <div className="min-w-0 xl:pt-[146px] anim-left-part anim-fade-left">
        ...
        <PeopleVisual block={block} primaryStat={primaryStat} profileStats={profileStats} className="anim-right-part anim-fade-right" />
      </Container>
    </section>
  )
}
...
function PeopleVisual({
  ...
  return (
    <div className={cn('relative mx-auto h-[600px] w-full max-w-[740px] min-w-0 xl:h-[552px] xl:max-w-none xl:w-full 2xl:w-[790px]', className)}>
      ...
      {primaryStat ? (
        <div className="about-Professionals-card absolute left-[0px] top-[0px] z-[3] h-[152px] w-[174px] bg-[#111A70]/92 px-[20px] pt-[23px] shadow-[0_24px_55px_rgba(0,0,0,0.22)] xl:left-[50px] 2xl:left-[90px]">
          ...
          <div className="mt-[13px] flex -space-x-[8px]">
            {avatarImages.map((avatar) => (
              <span key={avatar} className="relative h-[36px] w-[36px] overflow-hidden rounded-full">
      ...
      {block.primaryAction?.url ? (
        <ButtonLink
          ...
          className="consultation-session absolute bottom-[300px] left-[0px] z-[4] h-[50px] w-[204px] rounded-[0px] border-[0px] bg-[#FCA62B] px-[0px] text-[18px] font-[700] leading-[22px] tracking-[-3%] text-[#000D6B] hover:bg-[#E8951F] xl:bottom-auto xl:left-[24px] xl:top-[442px] 2xl:left-[50px] capitalize"
        >
      ...
      {block.overlayCard?.name ? (
        <div className="about-page-card absolute bottom-[0px] right-[0px] z-[5] h-[282px] w-[204px] bg-[#FFF8EE] text-[#151515] shadow-[0_26px_48px_rgba(0,0,0,0.28)] xl:left-auto xl:right-[0px] xl:top-[270px] 2xl:left-[586px] 2xl:right-auto">
